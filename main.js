...
//var regEx =/homeabout/i;
var home = document.getElementsByTagName("li");
if (title.indexOf("Home") != -1) {
    home[0].classList.toggle("active");
} else if (title.indexOf("Portfolio") != -1) {
    home[1].classList.toggle("active");
} else if (title.indexOf("Contact") != -1) {
    home[2].classList.toggle("active");
} else if (title.indexOf("Me") != -1) {
    home[3].classList.toggle("active");
}
...
if (window.innerWidth <= "768") {
    var deletee = document.getElementsByTagName('nav')[0];
    var elem = document.getElementsByTagName('footer')[0];
    deletee.removeChild(elem);
